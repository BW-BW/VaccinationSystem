 ...
 * @author LENOVO
 */
public class AdminAppointmentDelete extends javax.swing.JFrame {

    /**
     * Creates new form DeleteBooking
     */
    public AdminAppointmentDelete() {
        initComponents();
        Appointment viewAll = new Appointment(); //Create Object
        viewAll.viewAppointmentAll(tabelAppoint);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAppointmentDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAppointmentDelete().setVisible(true);
            }
        });
    }
